...
const style = StyleSheet.create({
  ...
  gameDetails: {
    fontSize: 28, color: 'white', fontFamily: family.Agency_Bold, letterSpacing: 2, marginLeft: 5
  },
  gameDataContainer: {
    flex: 3, width: '95%', marginHorizontal: '2.5%', justifyContent: 'center', alignItems: 'center', marginTop: 10, fontFamily: family.Agency_Bold,
  },
  gameDataText: {
